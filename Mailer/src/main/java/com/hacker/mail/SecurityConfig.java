...
import com.hacker.mail.handlers.FailureHandler;
import com.hacker.mail.handlers.SuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	logger.info("************* Entry configure ************* ");
		...
		.authorizeRequests().antMatchers("/persistFeedback").permitAll().and()
		...
		.authorizeRequests().antMatchers("/getFeedbackBybeneficiary/**").hasAnyAuthority("PMO","Admin").and()
		...
		.and().logout().logoutRequestMatcher(new AntPathRequestMatcher("/logout")).invalidateHttpSession(true).permitAll()
